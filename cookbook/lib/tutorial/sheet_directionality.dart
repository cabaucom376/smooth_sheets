        ...
        child: Column(
          ...
          children: [
            _buildDirectionButton(
              ...
              label: 'From Bottom',
              axisDirection: const SheetAxisDirection.fromBottom(),
            ),
            _buildDirectionButton(
              context,
              icon: Icons.arrow_downward_rounded,
              label: 'From Top',
              axisDirection: const SheetAxisDirection.fromTop(),
            ),
            _buildDirectionButton(
              context,
              icon: Icons.arrow_forward_rounded,
              label: 'From Left',
              axisDirection: const SheetAxisDirection.fromLeft(),
            ),
            _buildDirectionButton(
              context,
              icon: Icons.arrow_back_rounded,
              label: 'From Right',
              axisDirection: const SheetAxisDirection.fromRight(),
            ),
          ],
        ),
      ),
